      ...
      <Container>
        <Row>
          ...
          <Col lg="6" md="6" className={`${classes.service__title}`}>
            ...
            <h3 className="mb-0 mt-4">Better Learning,</h3>
            <h3 className="mb-4">Better Experience</h3>
            <p>
I've worked with a range of web development technologies across both frontend and full-stack projects. My experience includes leading project teams and collaborating with cross-functional groups to meet tight deadlines while delivering on project goals and staying within budget. My strengths include:
            </p>
